...
namespace ATReforged
{
    public class ATReforged_Settings : ModSettings
    {
        ...
        public override void ExposeData()
        {
            ...
            {
                Log.Warning("[ATR] Settings have saved ThingDefs that no longer exist! Resetting cached pawn considerations to avoid further issues. " + ex.Message + " " + ex.StackTrace);
                RebuildCaches();
            }
