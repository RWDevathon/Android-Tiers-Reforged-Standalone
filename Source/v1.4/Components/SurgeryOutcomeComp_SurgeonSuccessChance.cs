...
{
    // Override AffectQuality to use MechanicalSurgerySuccessChance instead of SurgerySuccessChance
    public class SurgeryOutcomeComp_MechanicSuccessChance : SurgeryOutcomeComp_SurgeonSuccessChance
    {
        ...
        {
            quality *= surgeon.GetStatValue(StatDefOf.MechanicalSurgerySuccessChance);
        }
    }
}